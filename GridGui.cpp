...
void Grid::getClick(int &x, int &y)
{
	Point p = cwin.get_mouse("Click to fill, click here to end") ;
	y = Y_SHIFT - int(p.get_y()+0.5); //round and shift
	x = int(p.get_x()+0.5 - X_SHIFT); //round and shift
}
